...
const gerarPdfResidencia = async (dados) => {
  ...
  const loadLogoBase64 = async () => {
    const asset = Asset.fromModule(require('../../assets/hospital.png')); // Altere o caminho conforme sua estrutura
    ...
    const htmlContent = `
      <html>
        ...
        <body>
          ...
          <h1>Devolução de Equipamento - Residência</h1>
          ...
          <div class="footer">
            Hospital Mahatma Gandhi - Devolução de Equipamento | Página 1
          </div>
        </body>
      </html>
    `;
